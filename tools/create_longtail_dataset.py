...
def create_voc_longtail(year=2012,  max=1400, b = 12, save_dir ='./appendix/VOCdevkit/', draw=False):
...
def create_coco_longtail(year=2017, max=1400, min=1, b =10, save_dir ='./appendix/coco', draw=False):
